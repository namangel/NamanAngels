...
function show(){
  ...
  var fname = document.forms["register_inv"]["fname"].value;
  var lname = document.forms["register_inv"]["lname"].value;
  var phone = document.forms["register_inv"]["phone"].value;
  var iname = document.forms["register_inv"]["iname"].value;
...
<?php require 'include/header/sign.php'; ?>
  ...
  <div class="header"><h2>Register - Invester</h2><hr></div>
          ...
          <div class="content" id="individual" style="display:none">
            <form method="POST" name="register_inv" action="register_inv.php">
                ...
                <div class="input-group">
                  ...
                  <div class="contbot" id="contbot">
                      <div class="input-group">
                        <button type="submit" class="btn" name="reginv_ind" onclick="validateForm()" style="background-color: #0e3c58;">Register Invester</button>
                      </div>
            ...
            <div class="content" id="institution"style="display:none">
              <form method="POST" name="register_inv" action="register_inv.php">
                ...
                <div class="contbot" id="contbot">
                  <div class="input-group">
                    <button type="submit" class="btn" name="reginv_inst" onclick="validateForm()" style="background-color: #0e3c58;">Register Invester</button>
                  </div>
                  <p style="font-size:15px">
                      Already a member? <a href="login_inv.php">Sign in</a>
                  </p>
