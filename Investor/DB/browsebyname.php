...
<body>
    ...
    <div class="browsesearch">
        ...
        <div class='output'>
            ...
            $total_pages_sql = "SELECT COUNT(*) FROM st_details where Stname LIKE '%{$sname}%'";
            ...
            $sql = "SELECT * FROM st_details where StName Like '%{$sname}%' LIMIT $offset, $no_of_records_per_page";
